...
public class ShopRepositoryTest {
    ...
    @Test
    public void test2(){
        List<Customer> customers = customerRepository.selectAllCustomer();
    ...
    @Test
    public void test5(){
        List<Customer> list1 = queryFactory.selectFrom(qCustomer)
                .where(qCustomer.age.gt(30))
                .fetch();
        List<Customer> list2 = queryFactory.selectFrom(qCustomer)
                .where(qCustomer.age.goe(30))
                .fetch();
        List<Customer> list3 = queryFactory.selectFrom(qCustomer)
                .where(qCustomer.age.lt(30))
                .fetch();
        List<Customer> list4 = queryFactory.selectFrom(qCustomer)
                .where(qCustomer.age.loe(30))
                .fetch();
        List<Customer> list5 = queryFactory.selectFrom(qCustomer)
    ...
    @Test
    public void test9(){
        ProductAggDTO resultDTO = queryFactory
                .select(
                        Projections.fields(
                                ProductAggDTO.class,
    ...
    public void test10(){
        ...
        List<Customer> list = queryFactory.select(Projections.fields(
                    Customer.class,
                ...
                .groupBy(qOrder.customer.custId, qOrder.customer.name)
    ...
    @Test
    public void test11(){
        List<Tuple> list = queryFactory.select(qOrder, qCustomer)
                .from(qOrder)
                .join(qCustomer)
